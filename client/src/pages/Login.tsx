    ...
    <div className="min-h-screen bg-[#f8f6fc] text-[#302a40]">
      <div className="mx-auto grid min-h-screen max-w-[1440px] lg:grid-cols-[.9fr_1.1fr]">
        <section className="relative hidden overflow-hidden bg-[#302742] p-10 text-white lg:flex lg:flex-col lg:justify-between lg:p-14 xl:p-20">
          ...
          <Link href="/" className="relative flex w-fit items-center gap-3" aria-label="Back to Gradify home"><span className="grid h-10 w-10 place-items-center rounded-[14px] bg-[#7658bd] text-white"><GraduationCap className="h-5 w-5" /></span><span className="text-[20px] font-semibold tracking-[-.05em]">gradify</span></Link>
        ...
        <main className="flex min-h-screen flex-col bg-white px-5 py-6 sm:px-10 lg:bg-[#f8f6fc] lg:px-16 lg:py-10 xl:px-24">
          <div className="flex items-center justify-between lg:hidden"><Link href="/" className="flex items-center gap-2.5"><span className="grid h-9 w-9 place-items-center rounded-[12px] bg-[#6e52b8] text-white"><GraduationCap className="h-[18px] w-[18px]" /></span><span className="text-[18px] font-semibold tracking-[-.05em]">gradify</span></Link><span className="text-[11px] font-medium text-[#9a91a5]">Teacher sign in</span></div>
